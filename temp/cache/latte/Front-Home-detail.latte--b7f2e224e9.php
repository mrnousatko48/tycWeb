        ...
        <div class="max-w-5xl w-full mx-auto p-6">
            ...
            <div class="grid grid-cols-1 md:grid-cols-2 gap-8">
                ...
                <div class="space-y-6">
                    ...
                    <!-- Clona předního fotoaparátu -->
                    <div>
                        <h2 class="text-xl font-medium text-gray-900">Clona předního fotoaparátu</h2>
                        <div class="mt-2 flex space-x-3">
                            <button class="px-4 py-2 bg-gray-200 text-gray-800 rounded-lg hover:bg-gray-300 transition" onclick="toggleSelection(this)">Ano</button>
                            <button class="px-4 py-2 bg-gray-200 text-gray-800 rounded-lg hover:bg-gray-300 transition" onclick="toggleSelection(this)">Ne</button>
                        </div>
                    </div>
