...
// source: /root/tycWeb/config/local.neon
// source: array
...
class Container_3a9010b2f9 extends Nette\DI\Container
{
	...
	protected array $wiring = [
		...
		'App\UI\Front\Cart\CartPresenter' => [2 => ['application.1']],
		'App\UI\Front\Sign\SignPresenter' => [2 => ['application.2']],
		'App\UI\Front\Home\HomePresenter' => [2 => ['application.3']],
		'App\UI\Front\Profile\ProfilePresenter' => [2 => ['application.4']],
		'App\UI\Admin\User\UserPresenter' => [2 => ['application.5']],
		'App\UI\Admin\Dashboard\DashboardPresenter' => [2 => ['application.6']],
	...
	public function createService06(): App\Model\PageFacade
	{
		return new App\Model\PageFacade($this->getService('database.default.explorer'));
	}


	public function createServiceApplication__1(): App\UI\Front\Cart\CartPresenter
	{
	...
	public function createServiceApplication__2(): App\UI\Front\Sign\SignPresenter
	{
	...
	{
		$service = new App\UI\Front\Home\HomePresenter($this->getService('04'), $this->getService('06'));
		$service->injectPrimary(
			$this->getService('http.request'),
			$this->getService('http.response'),
			$this->getService('application.presenterFactory'),
	...
	public function createServiceApplication__4(): App\UI\Front\Profile\ProfilePresenter
	{
	...
	public function createServiceApplication__5(): App\UI\Admin\User\UserPresenter
	{
		$service = new App\UI\Admin\User\UserPresenter($this->getService('05'));
		$service->injectPrimary(
			$this->getService('http.request'),
			$this->getService('http.response'),
			$this->getService('application.presenterFactory'),
	...
	public function createServiceApplication__6(): App\UI\Admin\Dashboard\DashboardPresenter
	{
	...
	public function createServiceLatte__latteFactory(): Nette\Bridges\ApplicationLatte\LatteFactory
	{
		return new class ($this) implements Nette\Bridges\ApplicationLatte\LatteFactory {
			public function __construct(
				private Container_3a9010b2f9 $container,
			) {
			}
